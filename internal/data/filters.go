...
// Note that when the last page is calculated we are dividing by two int values, and
// when dividing integers types in Go the result will also be an integer type, with
